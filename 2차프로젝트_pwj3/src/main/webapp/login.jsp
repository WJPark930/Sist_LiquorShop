...
<body>
		...
		<form action="loginPro.jsp" method="post">
			...
			<div class="form-floating">
				<input type="text" name="id" class="form-control" id="floatingInput"
					required> <label for="floatingInput">아이디 또는 이메일</label>
			</div>
			...
			<div class="form-check text-start my-3">
				<input class="form-check-input" type="checkbox" value="이메일 기억하기"
			...
			<div class="d-flex justify-content-between align-items-center mb-3">
				...
				<script>
  Kakao.init('361909877913cc7b0c0b0558aa7e0e7c'); // 사용하려는 앱의 JavaScript 키 입력
</script>
  ...
  function getCookie(name) {
    ...
    if (parts.length === 2) { return parts[1].split(';')[0]; }
            ...
            %>
				<a href="<%=apiURL%>"><img width: 200px; height=45px;
			...
			<button class="btn btn-primary w-100 py-2" type="button"
				onclick="forgotPassword()">아이디 혹은 비밀번호를 잊으셨나요?</button>
			<br> <br>
			<button class="btn btn-primary w-100 py-2" type="button"
				onclick="register()">회원가입 하기</button>
			<br> <br>
			<button class="btn btn-primary w-100 py-2" type="button"
				onclick="goToMall()">비회원으로 구경하기</button>
