...
<body>
 ...
 <form action="findpwProc.jsp" method="post">
    ...
    <div class="form-floating mb-3">
     ...
     <div class="form-floating mb-3">
        <input type="text" name="id" class="form-control" id="floatingInput" required autofocus>
        <label for="floatingInput">가입하신 아이디를 입력해 주세요</label>
    </div>
    ...
    <button class="btn btn-primary w-100 py-2" type="submit">비밀번호 찾기</button><br><br>
